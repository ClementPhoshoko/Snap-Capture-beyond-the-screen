(function(){"use strict";const u="snap-capture-overlay",W="snap-overlay-styles",_={screenshot:{status:"Preparing capture",subtext:"Capturing visible area"},fullpage:{status:"Preparing capture",subtext:"Measuring page dimensions"}};let c=null,m=null,b=null;function B(){return`
#${u} {
...
`}function G({mode:t="screenshot"}={}){if(c)return;const e=_[t]||_.screenshot;m=document.createElement("style"),m.id=W,m.textContent=B(),document.head.appendChild(m),c=document.createElement("div"),c.id=u;const n=window.matchMedia("(prefers-reduced-motion: reduce)").matches;c.innerHTML=`
